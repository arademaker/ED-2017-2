...
vector, min is the smallerinteger and ix is the current number being
counted. return count-vector where count-vector[ix] is number of
elements equal to min+ix in vector."
  (if (= ix (length vector))
      count-vector
...
elements are less or equal than it, and places it at the appropriate
index at sorted-vector. decrements this count in count-vector, and
